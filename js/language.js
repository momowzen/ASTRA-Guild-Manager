const LANG = {
  en: {
    ...
    killedActivity: "Killed {boss} with {count} {label}",
    analyticsPrevCp: "Previous CP",
    analyticsCurrentCp: "Current CP",
    analyticsPctChange: "% Change",
    analyticsProgress: "Progress",
    analyticsUpdates: "Updates",
    analyticsNew: "New",
  ...
  ko: {
    ...
    clickToView: "클릭하여 보기",
    combatPower: "전투력",
    killedActivity: "{boss} 처치, {count}명 참여",
    analyticsPrevCp: "이전 CP",
    analyticsCurrentCp: "현재 CP",
    analyticsPctChange: "% 변동",
    analyticsProgress: "진행도",
    analyticsUpdates: "업데이트",
    analyticsNew: "신규",
    mainWeapon: "주 무기",
  ...
  ja: {
    ...
    combatPower: "戦闘力",
    killedActivity: "{boss}を撃破、{count}人参加",
    analyticsPrevCp: "前回CP",
    analyticsCurrentCp: "現在CP",
    analyticsPctChange: "%変化",
    analyticsProgress: "進捗",
    analyticsUpdates: "更新数",
    analyticsNew: "新規",
    mainWeapon: "メイン武器",
